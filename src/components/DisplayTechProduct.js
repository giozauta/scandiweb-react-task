...
export default class DisplayTechProduct extends Component {
    constructor(props){
        super(props)
        this.state={
    ...
    return (
      <div>
          ...
          <div className="productConteiner">
              ...
              /*for returning only tech*/
                  products.category==="tech"&&products.inStock==true?
              ...
              /*for returning out of stock */
                  products.category==="tech"&&products.inStock==false?
                      <div className="allProducts" key={products.id}>      
                          <div key={products.id} className={products.name}>
